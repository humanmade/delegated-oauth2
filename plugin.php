...
namespace HM\Delegated_OAuth2_Authentication;
...
function attempt_authentication( $user = null ) {
	...
	$user = create_user_from_remote_user( $remote_user );
...
function get_remote_user_for_token( string $token ) {
	$response = wp_remote_get( 'http://10.200.10.1:1123/?rest_route=/wp/v2/users/me&context=edit', [
		'headers' => [
